...
Public Class Form1
    ...
    Private Sub СреденУспехЗаЕднаГодинаToolStripMenuItem_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles СреденУспехЗаЕднаГодинаToolStripMenuItem.Click
        Reference_Universal_GPA.ShowDialog()
    End Sub
End Class
