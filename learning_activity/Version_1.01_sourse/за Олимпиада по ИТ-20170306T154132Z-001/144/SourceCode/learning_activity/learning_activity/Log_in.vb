...
Public Class Log_in
    ...
    Private Sub Button1_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button1.Click
        ...
        If flag = 1 Then
            ...
            cnn.Open()
            Try
                cmd = New MySqlCommand("CREATE TABLE `absence` ( `id` int(10) UNSIGNED NOT NULL, `class` int(11) UNSIGNED NOT NULL, `count_excused` decimal(10,2) UNSIGNED NOT NULL, `count_unexcused` decimal(10,2) UNSIGNED NOT NULL, `time` enum('Първи срок','Втори срок') NOT NULL ) ENGINE=InnoDB DEFAULT CHARSET=utf8", cnn)
                cmd.ExecuteNonQuery()
            Catch ex As Exception
            End Try
            prb1.Value = 1
            ...
            prb1.Value = 4
            Try
                cmd = New MySqlCommand("CREATE TABLE `subject` ( `id` int(10) UNSIGNED NOT NULL, `name_subject` varchar(35) NOT NULL ) ENGINE=InnoDB DEFAULT CHARSET=utf8", cnn)
                cmd.ExecuteNonQuery()
            Catch ex As Exception
            End Try
            prb1.Value = 5
