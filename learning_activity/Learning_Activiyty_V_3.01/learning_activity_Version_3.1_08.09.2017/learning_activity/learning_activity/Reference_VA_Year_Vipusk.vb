...
Public Class Reference_VA_Year_Vipusk
    ...
    Private Sub cmbVipusk_Leave(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmbYearString.Leave
    ...
    Private Sub btnchart_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnchart.Click
        If cmbYear.Text <> "" Then
            ...
            If RRowsCount > 0 Then
                ...
                Dim clas As Integer = cmbClass.Text
                title2 = "Съотношение на оценките по брой за 2 години: "
                title2 = title2 & y & " " & clas & " клас, предмет: " & cmbSubject.Text & ", вид оценка: " & cmbtype.Text
    ...
    False, True, False, False, False, True, False, False, False)
                    ...
                    chartPage2.ApplyDataLabels(Microsoft.Office.Interop.Excel.XlDataLabelsType.xlDataLabelsShowLabel, _
    False, True, False, False, False, True, False, False, False)
                    chartPage2.ShowDataLabelsOverMaximum = True
    ...
    Private Sub btnWordNewFIle_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnWordNewFIle.Click
        If cmbYear.Text <> "" Then
            ...
            If SaveFileDialog1.ShowDialog = DialogResult.OK Then
                ...
                Dim clas As Integer = cmbClass.Text
                title2 = "Съотношение на оценките по брой за 2 години: "
                title2 = title2 & y & " - " & cmbYear.Text - 1 & "/" & cmbYear.Text Mod 100 & " " & clas & " клас, предмет: " & cmbSubject.Text & ", вид оценка: " & cmbtype.Text
