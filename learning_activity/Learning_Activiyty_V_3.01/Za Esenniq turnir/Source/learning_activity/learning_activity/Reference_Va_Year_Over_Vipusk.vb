    ...
    Private Sub btnExselNewFile_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnExselNewFile.Click
        If cmbYear.Text <> "" Then
            ...
            If SaveFileDialog1.ShowDialog = DialogResult.OK Then
                ...
                cp1.HasTitle = True
                cp1.ChartTitle.Text = xlsheet.Range("D2").Value()
                cp2.HasTitle = True
                cp2.ChartTitle.Text = xlsheet.Range("G2").Value()
                cp3.HasTitle = True
                cp3.ChartTitle.Text = xlsheet.Range("J2").Value()
                cp4.HasTitle = True
                cp4.ChartTitle.Text = xlsheet.Range("M2").Value()
                Dim rng As Microsoft.Office.Interop.Excel.Range
                rng = xlsheet.Range("A1:N8")
                Call cellborder(rng)
...
False, True, False, False, False, True, False, False, False)
                ...
                cp1.ApplyDataLabels(Microsoft.Office.Interop.Excel.XlDataLabelsType.xlDataLabelsShowLabel, _
False, True, False, False, False, True, False, False, False)
                cp1.ShowDataLabelsOverMaximum = True
                cp2.ApplyDataLabels(Microsoft.Office.Interop.Excel.XlDataLabelsType.xlDataLabelsShowLabel, _
False, True, False, False, False, True, False, False, False)
                cp2.ShowDataLabelsOverMaximum = True
                cp3.ApplyDataLabels(Microsoft.Office.Interop.Excel.XlDataLabelsType.xlDataLabelsShowLabel, _
False, True, False, False, False, True, False, False, False)
                cp3.ShowDataLabelsOverMaximum = True
                cp4.ApplyDataLabels(Microsoft.Office.Interop.Excel.XlDataLabelsType.xlDataLabelsShowLabel, _
False, True, False, False, False, True, False, False, False)
                cp4.ShowDataLabelsOverMaximum = True
        ...
        If cmbYear.Text <> "" Then
            ...
            If OpenFileDialog1.ShowDialog = DialogResult.OK Then
                ...
                Try
                    ...
                    cp1.HasTitle = True
                    cp1.ChartTitle.Text = ws.Range("D2").Value()
                    cp2.HasTitle = True
                    cp2.ChartTitle.Text = ws.Range("G2").Value()
                    cp3.HasTitle = True
                    cp3.ChartTitle.Text = ws.Range("J2").Value()
                    cp4.HasTitle = True
                    cp4.ChartTitle.Text = ws.Range("M2").Value()
